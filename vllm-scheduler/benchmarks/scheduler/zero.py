...
def run_vllm(
    ...
    ###########################################################################
    # Zero-cpu-time scheduling:
    #
    # it's similar to built-in scheduling,
    # but fire a request when "accumulated GPU time" becomes the specified
    # arrival time of the request, not "accumulated CPU+GPU time" for built-in
    # scheduling.
    #
    # This is useful for testing the performance of the scheduler when the
    # CPU time is zero.
    #
    ###########################################################################
