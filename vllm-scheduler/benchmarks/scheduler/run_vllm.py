...
from generate_precomputed_schedule import (
    generate_precomputed_schedule,
    generate_precomputed_schedule_from_vidur,
...
def main(args: argparse.Namespace):
    ...
    if args.vidur:
        ...
        schedule = generate_synthetic_schedule(
            args.I, args.O, args.B, args.prefill_chunk_size
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--schedule", type=str, default="./schedule.pkl", help="Path to the schedule"
    )
    parser.add_argument(
