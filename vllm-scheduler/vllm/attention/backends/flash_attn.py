...
class FlashAttentionImpl(AttentionImpl):
    ...
    def forward(
        ...
        # try:
        #     precomputed_schedule.attn_time[-1] += time.time() - start_time
        # except:
        #     pass
        ...
        # #print('flash attention impl forward start', start_time)
        #     output = torch.ops.vllm.unified_flash_attention(
        #         query,
        #         key,
        #         value,
        ...
        # precomputed_schedule = PrecomputedSchedule()
        # profile_log = str(prof.key_averages().table(sort_by="cuda_time_total", row_limit=10))
        # #print(profile_log)
        # try:
        #     precomputed_schedule.attn_profile_log[-1].append(profile_log)
        # except:
        #     pass
        # return output
