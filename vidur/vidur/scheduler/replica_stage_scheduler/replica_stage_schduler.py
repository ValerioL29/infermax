...
class ReplicaStageScheduler:
    ...
    def on_schedule(self) -> Tuple[Batch, BatchStage, ExecutionTime]:
        ...
        assert(batch._total_num_tokens_rounded <= 16384, f"batch._total_num_tokens: {batch._total_num_tokens} batch._total_num_tokens_rounded: {batch._total_num_tokens_rounded}")
