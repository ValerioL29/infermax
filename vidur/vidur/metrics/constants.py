...
class BatchMetricsCountDistribution(enum.Enum):
    ...
    BATCH_NUM_PREFILL_TOKENS_SQUARE = "batch_num_prefill_tokens_square"
    BATCH_NUM_PREFILL_TOKENS_DOT_KVS = "batch_num_prefill_tokens_dot_kvs"
    BATCH_NUM_PREFILL_KVS = "batch_num_prefill_kvs"
    BATCH_NUM_PREFILL_REQUESTS = "batch_num_prefill_requests"
    BATCH_NUM_DECODE_TOKENS = "batch_num_decode_tokens"
    BATCH_NUM_DECODE_KVS = "batch_num_decode_kvs"
    BATCH_NUM_DECODE_REQUESTS = "batch_num_decode_requests"
