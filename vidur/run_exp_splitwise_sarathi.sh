...
python -m vidur.main --replica_config_model_name meta-llama/Meta-Llama-3-70B \
    ...
    --sarathi_scheduler_config_block_size $bsize \
    --sarathi_scheduler_config_batch_size_cap $max_B \
    --sarathi_scheduler_config_num_blocks $M \
    ...
    --sarathi_scheduler_config_watermark_blocks_fraction 0 \
