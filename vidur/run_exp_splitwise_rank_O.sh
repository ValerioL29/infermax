...
python -m vidur.main --replica_config_model_name meta-llama/Meta-Llama-3-70B \
    ...
    --replica_scheduler_config_type rank \
    --rank_scheduler_config_sorted_by I \
    --rank_scheduler_config_block_size $bsize \
    --rank_scheduler_config_batch_size_cap $max_B \
    --rank_scheduler_config_num_blocks $M \
    --rank_scheduler_config_chunk_size $C \
    ...
    --rank_scheduler_config_watermark_blocks_fraction 0 \
